      ...
      <div className="w-full bg-[#000000] lg:w-[1220px] analytics-background-gradient lg:rounded-2xl flex-wrap md:flex-nowrap cursor-default select-none bg-opacity-02 xxl:mr-10 overflow-x-hidden overflow-y-hidden border-white/10 border border-b-0 border-l-0  border-r-0 flex-col md:flex-row relative rounded-tl-3xl h-[600px] xl:h-[576px] flex">
        ...
        <div className="flex flex-col rounded-2xl w-[216px] h-full text-white/20  text-xs pt-6 px-4 md:border-r md:border-white/5">
          <div className="flex justify-between items-center w-[160px]">
            ...
            <p className="font-bold text-white/80">Vietcod</p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <p className="my-6 uppercase tracking-widest font-semibold text-[10px]">
            Hệ thống CMS
          </p>
          <div>
            <p className="flex items-center text-white/60 mb-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
          ...
          <p className="mt-8 font-semibold text-white/40 uppercase text-[9px] tracking-widest">
            Chức năng hệ thống
          </p>
          <div className="mt-4 space-y-1">
            ...
            />
            <Tab backgroundColor="#00A2C7" text="Mốc nạp" icon={icons.crypto} />
            <Tab backgroundColor="#8DB654" text="Người chơi" icon={icons.bio} />
          </div>
        </div>
        <div className="text-white pt-4 pl-8 flex w-full px-[40px] flex-col">
          <div className="flex justify-between w-full h-[40px] items-center">
            <div className="flex items-center text-lg font-medium min-w-[400px]">
              <div className="bg-[#4c32b3] mr-3.5 w-[40px] h-[40px] rounded-[9px] flex items-center justify-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
            ...
            <div className="flex items-center">
              ...
              <div className="px-3 py-1 ml-4 text-xs font-bold text-black bg-white rounded cursor-pointer hover:bg-white/90 transition-colors">
                Thêm Server
              </div>
            </div>
          </div>
          <div className="pl-3 border-b-[0.75px] before:left-0 before:top-[30px] before:w-[85px] before:h-[1px] before:bg-white before:absolute relative border-white/15 mt-[34px] text-xs pb-[10px] flex flex-row gap-x-8">
            <p className="cursor-pointer">Thống kê</p>
            <p className="text-white/40 cursor-pointer hover:text-white/60">
              Người chơi
            </p>
            <p className="text-white/40 cursor-pointer hover:text-white/60">
              Sự kiện
          ...
          <div className="border-[0.75px] border-white/15 p-6 gap-x-6 mt-[32px] rounded-2xl flex bg-white/[0.02]">
            <div className="flex flex-col min-w-[100px]">
              <p className="text-xs text-white/40 uppercase tracking-tighter">
                Doanh thu 30 ngày
              </p>
              <p className="pt-2 font-bold text-green-400 text-lg">152,400k</p>
            </div>
            <div className="flex flex-col min-w-[100px]">
              <p className="text-xs text-white/40 uppercase tracking-tighter">
                Trạng thái
              </p>
              <p className="pt-2 font-medium text-blue-400">Ổn định</p>
            </div>
            <div className="flex flex-col min-w-[100px]">
              <p className="text-xs text-white/40 uppercase tracking-tighter">
                CCU Đỉnh
              </p>
              <p className="pt-2 font-bold">2,450</p>
            </div>
            <div className="flex flex-col min-w-[100px]">
              <p className="text-xs text-white/40 uppercase tracking-tighter">
                Phát sinh lỗi
              </p>
              <p className="pt-2 font-medium text-white/60">0</p>
            </div>
            <div className="flex flex-col min-w-[100px]">
              <p className="text-xs text-white/40 uppercase tracking-tighter">
                Lượt thanh toán
              </p>
              <p className="pt-2 font-bold">1,850</p>
            </div>
            <div className="flex flex-col">
              <p className="text-xs text-white/40 uppercase tracking-tighter">
                Mã Server
              </p>
              <div className="flex items-center gap-2 px-2 py-1 font-mono text-[10px] rounded-lg bg-white/5 font-sm text-white/40 mt-2 border border-white/5">
                sv_Vietcod_S1_2026
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
          ...
          <div className="border-[0.75px] border-white/15 p-6 gap-x-6 mt-[32px] rounded-2xl flex flex-col bg-white/[0.01]">
            <div className="flex items-center justify-between w-full text-xs text-white/30">
              <div className="min-w-[400px]">
                <h3 className="text-base font-bold text-white/90">
                  Biểu đồ CCU Realtime
                </h3>
                <p>Giám sát lượng truy cập đồng thời của người chơi</p>
              </div>
              <div className="flex items-center">
                <div className="w-[6px] h-[6px] bg-white mr-3 rounded-full" />
                <p>Người chơi</p>
              </div>
              <div className="flex items-center">
                <div className="w-[6px] h-[6px] bg-[#8F6424] mr-3 rounded-full" />
                <p>Thanh toán</p>
              </div>
              <div className="flex items-center">
                <div className="w-[6px] h-[6px] bg-[#853A2D] mr-3 rounded-full" />
                <p>Cảnh báo</p>
              </div>
            </div>
            <div className="flex items-end mt-4 space-x-10 bar-chart">
              <div className="bg-white/90 h-[20px] min-w-[10px] mb-[20px] ml-6 rounded-t-sm" />
              <div className="bg-white/90 h-[100px] min-w-[10px] mb-[20px] rounded-t-sm" />
              <div className="bg-white/90 h-[80px] min-w-[10px] mb-[20px] rounded-t-sm" />
              <div className="bg-white/90 h-[40px] min-w-[10px] mb-[20px] rounded-t-sm" />
              <div className="bg-white/90 h-[60px] min-w-[10px] mb-[20px] rounded-t-sm" />
              <div className="bg-white/90 h-[100px] min-w-[10px] mb-[20px] rounded-t-sm" />
              <div className="bg-white/90 h-[40px] min-w-[10px] mb-[20px] rounded-t-sm" />
              <div className="bg-white/90 h-[30px] min-w-[10px] mb-[20px] rounded-t-sm" />
              <div className="bg-white/90 h-[20px] min-w-[10px] mb-[20px] rounded-t-sm" />
              <div className="bg-white/90 h-[30px] min-w-[10px] mb-[20px] rounded-t-sm" />
              <div className="bg-white/90 h-[50px] min-w-[10px] mb-[20px] rounded-t-sm" />
              <div className="bg-white/90 h-[90px] min-w-[10px] mb-[20px] rounded-t-sm" />
              <div className="bg-white/90 h-[70px] min-w-[10px] mb-[20px] rounded-t-sm" />
              <div className="bg-white/90 h-[90px] min-w-[10px] mb-[20px] rounded-t-sm" />
              <div className="bg-white/90 h-[110px] min-w-[10px] mb-[20px] rounded-t-sm" />
              <div className="bg-white/90 h-[100px] min-w-[10px] mb-[20px] rounded-t-sm" />
            </div>
          </div>
        </div>
  ...
  return (
    ...
    >
      ...
      <p className="mt-4 leading-6 text-white/60">
        Theo dõi biến động dòng tiền, chỉ số CCU và nhật ký vận hành trực tiếp.
        Giúp bạn làm chủ mọi con số để tối ưu hóa chiến lược kinh doanh Game.
      </p>
    </div>
  );
}
