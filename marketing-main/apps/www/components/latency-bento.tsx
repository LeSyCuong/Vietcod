  ...
  return (
    <div className="flex flex-col text-white absolute left-[20px] sm:left-[40px] xl:left-[40px] bottom-[40px] max-w-[330px]">
      ...
      <p className="mt-4 leading-6 text-white/60">
        Vietcod cung cấp hạ tầng máy chủ ổn định trên phạm vi toàn cầu, đảm bảo
        mượt mà bất kể người chơi của bạn đang ở đâu hay đang sử dụng nhà cung
        cấp dịch vụ mạng nào.
      </p>
    </div>
  );
}
