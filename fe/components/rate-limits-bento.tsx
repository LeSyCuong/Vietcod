  ...
  return (
    <div className="flex flex-col text-white absolute left-[20px] sm:left-[40px] xl:left-[40px] bottom-[40px] max-w-[350px]">
      ...
      <p className="mt-4 leading-6 text-white/60">
        Tự động giới hạn tần suất gửi lệnh theo từng người chơi và địa chỉ IP.
        Hệ thống phản hồi ngay lập tức tại lớp hạ tầng để ngăn chặn tool scan và
        các đợt tấn công từ chối dịch vụ.
      </p>
    </div>
  );
}
