      ...
      <div className="flex flex-col items-center justify-center w-full xl:flex-row xl:justify-between">
        ...
        >
          <SectionTitle
            ...
            text="Chúng tôi bàn giao trọn bộ hệ thống Game bao gồm Server, Client và Source Code hệ thống Web quản trị. Vietcod cam kết hướng dẫn vận hành chi tiết, giúp bạn làm chủ hoàn toàn nền tảng kinh doanh của mình với quy trình minh bạch và chuyên nghiệp."
          >
            <div className="flex mt-10 space-x-6">
              <Link href="https://zalo.me/0865811722" className="group">
                <PrimaryButton
                  IconLeft={Star}
                  label="Nhận tư vấn bàn giao"
                  shiny
                />
              </Link>
            </div>
