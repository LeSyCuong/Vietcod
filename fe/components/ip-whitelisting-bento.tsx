  ...
  return (
    <div className="flex flex-col text-white absolute left-[20px] sm:left-[40px] xl:left-[40px] bottom-[40px] max-w-[350px]">
      ...
      <p className="mt-4 leading-6 text-white/60">
        Kiểm soát truy cập nghiêm ngặt bằng cách chỉ cho phép các địa chỉ IP
        được chỉ định tương tác với hệ thống, thiết lập thêm một lớp bảo vệ vững
        chắc cho cổng quản trị của bạn.
      </p>
    </div>
  );
}
